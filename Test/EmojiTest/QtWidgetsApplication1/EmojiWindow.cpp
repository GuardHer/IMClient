...
EmojiWindow::EmojiWindow(const EmojiDb& emojiDb, const bool darkBg) :
    _emojiDb {&emojiDb}
{
    this->setWindowIcon(QIcon {QString {R"(E:\StudyVideo\IMClient\Test\EmojiTest\QtWidgetsApplication1\assets)"} + "/icon.png"});
